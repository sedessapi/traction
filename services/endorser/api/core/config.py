...
class GlobalConfig(BaseSettings):
    ...
    # PSQL_HOST: str = os.environ.get("ENDORSER_POSTGRESQL_HOST", "localhost")  // amz
    PSQL_HOST: str = os.environ.get("ENDORSER_POSTGRESQL_HOST", "dev2.1pass.org")
    ...
    ACAPY_ADMIN_URL: str = os.environ.get(
        # "ENDORSER_ACAPY_ADMIN_URL", "http://localhost:9031"   // amz
        "ENDORSER_ACAPY_ADMIN_URL", "http://dev2.1pass.org:9031"
    )
