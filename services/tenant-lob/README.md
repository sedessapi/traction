...
1. Create set of demo tenants
    1. Open browser at [http://dev3.1pass.org:9876/tasks/create-alice-faber-acme](http://dev3.1pass.org:9876/tasks/create-alice-faber-acme)
    ...
    4. Note: in the docker terminal, each of the tenant's `wallet_id`, `wallet_key` and tokens are printed out. You could use these to login to [tenant-ui](http://dev3.1pass.org:5101)
2. Connect demo tenants 
    1. Open browser at [http://dev3.1pass.org:9876/tasks/connect-alice-faber-acme](http://dev3.1pass.org:9876/tasks/connect-alice-faber-acme)
    ...
    4. Open browser at [http://dev3.1pass.org:9876/tenants/alice/webhook-data](http://dev3.1pass.org:9876/tenants/alice/webhook-data) to view alice's webhook data.
    5. Open browser at [http://dev3.1pass.org:9876/tenants/faber/webhook-data](http://dev3.1pass.org:9876/tenants/faber/webhook-data) to view faber's webhook data.
    6. Open browser at [http://dev3.1pass.org:9876/tenants/acme/webhook-data](http://dev3.1pass.org:9876/tenants/acme/webhook-data) to view acme's webhook data.
...
3. Get faber a Public DID 
    1. Open browser at [http://dev3.1pass.org:9876/tenants/faber/public-did](http://dev3.1pass.org:9876/tenants/faber/public-did)
    ...
    4. Open browser at [http://dev3.1pass.org:9876/tenants/faber/webhook-data](http://dev3.1pass.org:9876/tenants/faber/webhook-data) to view faber's webhook data.
...
When creating your own tenants in the [tenant-ui](http://dev3.1pass.org:5101), you can update their webhook url to `http://host.docker.internal:9876/webhook` and do not add an api key. You can see notifications for you webhook in the `tenant-lob` docker console.
